// ^4.13.6 means that we can intersect with any version of package with Major version is 4. minor and patch version should be fully updated.
...
// there are two ways
// 1-  is to check the package.json file inside the installed package in node_modules. its a very tidious task to check the diferent installed packages one by one.
