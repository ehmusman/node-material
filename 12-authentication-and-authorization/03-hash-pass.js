...
run()
// as an argument we pass the number of rounds when we run this algorithm to generate the salt. the higher the number the longer it takes to generate the salt and also the salt will be more complex and harder to break.the default value is 10
